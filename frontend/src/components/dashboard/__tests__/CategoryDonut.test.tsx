...
describe("CategoryDonut legend", () => {
  beforeEach(() => {
    ...
    testState.transactions = [
      { id: 1, user_id: 1, amount: "75", description: "", date: "2026-05-10", category_id: 1, is_recurring: false, currency: "CHF", base_amount: "75", created_at: "", updated_at: "" },
      { id: 2, user_id: 1, amount: "25", description: "", date: "2026-05-11", category_id: 2, is_recurring: false, currency: "CHF", base_amount: "25", created_at: "", updated_at: "" },
    ];
  });
