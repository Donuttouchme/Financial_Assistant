...
describe("BudgetWidget", () => {
  it("renders an aggregate top line and per-category rows sorted by % desc", async () => {
    ...
    testState.transactions = [
      ...
      { id: 100, amount: "320", date: "2026-05-10", category_id: 1, description: "", is_recurring: false, created_at: "", updated_at: "" },
      // Groceries: 380 of 500 (76%)
      { id: 101, amount: "380", date: "2026-05-10", category_id: 2, description: "", is_recurring: false, created_at: "", updated_at: "" },
      // Transport: 280 of 650 (43%)
      { id: 102, amount: "280", date: "2026-05-10", category_id: 3, description: "", is_recurring: false, created_at: "", updated_at: "" },
    ];
